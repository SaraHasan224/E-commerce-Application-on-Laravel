...
<script src="<?php echo e(asset('js/backend_js/excanvas.min.js')); ?>"></script> 
...
<script src="<?php echo e(asset('js/backend_js/jquery.flot.min.js')); ?>"></script> 
<script src="<?php echo e(asset('js/backend_js/jquery.flot.resize.min.js')); ?>"></script> 
<script src="<?php echo e(asset('js/backend_js/jquery.peity.min.js')); ?>"></script> 
<script src="<?php echo e(asset('js/backend_js/fullcalendar.min.js')); ?>"></script> 
<script src="<?php echo e(asset('js/backend_js/matrix.js')); ?>"></script> 
<script src="<?php echo e(asset('js/backend_js/matrix.dashboard.js')); ?>"></script> 
<script src="<?php echo e(asset('js/backend_js/jquery.gritter.min.js')); ?>"></script> 
<script src="<?php echo e(asset('js/backend_js/matrix.interface.js')); ?>"></script> 
<script src="<?php echo e(asset('js/backend_js/matrix.chat.js')); ?>"></script> 
...
<script src="<?php echo e(asset('js/backend_js/jquery.wizard.js')); ?>"></script> 
