...
<div id="breadcrumb"> 
        ...
        <a href="{{url('/admin/products/add')}}" title="Add Products" class="tip-bottom"><i class="icon-plus"></i>Add Alternate Images</a> 
    </div>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" action="{{ url('/admin/products/alternate-images/add/'.$productDetails->product_id) }}" method="post" class="form-horizontal" id="add_attribute" name="add_attribute">{{csrf_field()}}
                ...
                <label class="control-label">Alternate Images :</label>
                  <div class="field_wrapper controls">
                      <div>
                          ...
                          <a href="javascript:void(0)" class="btn btn-default add_image_button"><span class="icon icon-plus" aria-hidden="true"></span> Add</a>
                      </div>
                  </div>
              </div>
