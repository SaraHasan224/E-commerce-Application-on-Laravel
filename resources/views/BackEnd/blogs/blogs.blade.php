            ...
            <table class="table table-bordered table-striped with-check data-table">
              ...
              <tbody>
                    ...
                    <tr>
                        ...
                        <td>/blogs/{{$post->url}}</td>
                        <td><img src="{{asset('/images/backend_images/blogs/'.$post->image)}}" style="width:150px height:200px"/></td>
                        <td>
                            @if($post->status == 1)                              
                        ...
                        <td>
                          <a href="{{url('/admin/blogs/edit/'.$post->id)}}" type="button" class="btn btn-primary">Edit</a>
                          <a href="{{url('/admin/blogs/delete/'.$post->id)}}" type="button" class="btn btn-danger delete">Delete</a>
                        </td>
                    </tr>
                    @endforeach
